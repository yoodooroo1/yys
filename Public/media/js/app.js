...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                var parent = $(this).parent().parent();    //ul.page-sidebar-menu

                parent.children('li.open').children('a').children('.arrow').removeClass('open');  //横条：会员管理
                parent.children('li.open').children('.sub-menu').slideUp(200);//新的打开，旧的收起
