...
if(browser.versions.ios){
	$('body,div,input,span,p,span,li,ul,h4,button,i,img,h3,a,audio').css('font-size','14px');
}else if(browser.versions.android){
	$('body,div,input,span,p,span,li,ul,h4,button,i,img,h3,a,audio').css('font-size','13px');
}else if(browser.versions.iPad){
	$('body,div,input,span,p,span,li,ul,h4,button,i,img,h3,a,audio').css('font-size','15px');
}else{
	$('body,div,input,span,p,span,li,ul,h4,button,i,img,h3,a,audio').css('font-size','14px');
}