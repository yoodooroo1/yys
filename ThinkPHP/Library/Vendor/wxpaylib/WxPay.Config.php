...
/*  define('WxPayConfig_SSLCERT_PATH', '/yqgcert/apiclient_cert.pem');
 define('WxPayConfig_SSLKEY_PATH', '/yqgcert/apiclient_key.pem');
 define('ROOTCA_PATH','/yqgcert/rootca.pem'); */
